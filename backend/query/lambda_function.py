...
def query_all_rounds(params: dict, parquet_path: str) -> dict:
    ...
    query = f"""
        SELECT
            ...
            back_par,
            back_vs_par,
            hole_1_score, hole_1_par,
            hole_2_score, hole_2_par,
            hole_3_score, hole_3_par,
            hole_4_score, hole_4_par,
            hole_5_score, hole_5_par,
            hole_6_score, hole_6_par,
            hole_7_score, hole_7_par,
            hole_8_score, hole_8_par,
            hole_9_score, hole_9_par,
            hole_10_score, hole_10_par,
            hole_11_score, hole_11_par,
            hole_12_score, hole_12_par,
            hole_13_score, hole_13_par,
            hole_14_score, hole_14_par,
            hole_15_score, hole_15_par,
            hole_16_score, hole_16_par,
            hole_17_score, hole_17_par,
            hole_18_score, hole_18_par,
            temp_f,
            wind_mph,
            weather_desc
        FROM rounds
